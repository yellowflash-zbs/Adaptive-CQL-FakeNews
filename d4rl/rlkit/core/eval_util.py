...
def get_generic_path_information(paths, stat_prefix='', env=None):
    """
    ...
    statistics[stat_prefix + 'Average Returns'] = average_returns
    if env is not None:
        statistics['Normalized Returns'] = env.get_normalized_score(average_returns) * 100.0
